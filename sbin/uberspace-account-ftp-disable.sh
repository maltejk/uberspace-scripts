...
########################################################################
#
# This script will disable FTP for an uberspace user. Since FTP is
# usually turned of for uberspace user by default, this is only
# necessary after FTP was enabled.
#
# For some reason vsftpd has two blocklists, so the user will be added
# to both.
#
########################################################################
